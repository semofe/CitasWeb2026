...
const mapUserRow = (user) => ({
  ...
  email: user.email,
  telefono: user.phone,
  sexo: user.sexo === "M" ? "Masculino" : user.sexo === "F" ? "Femenino" : user.sexo === "O" ? "Otro" : "No especificado",
  rol: user.role,
...
const mapCitaRow = (cita) => ({
  ...
  paciente_sexo: cita.paciente?.sexo === "M" ? "Masculino" : cita.paciente?.sexo === "F" ? "Femenino" : cita.paciente?.sexo === "O" ? "Otro" : "No especificado",
...
const mapCitaHistorialRow = (citaHistorial) => ({
  ...
  paciente_sexo: citaHistorial.paciente?.sexo === "M" ? "Masculino" : citaHistorial.paciente?.sexo === "F" ? "Femenino" : citaHistorial.paciente?.sexo === "O" ? "Otro" : "No especificado",
